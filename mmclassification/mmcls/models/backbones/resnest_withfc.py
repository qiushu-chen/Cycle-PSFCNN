...
from .resnet_withfc import ResNetWithFC
...
class ResNetV1dWithFC(ResNetWithFC):
    """ResNetV1d backbone.
    ...
    def __init__(self, **kwargs):
        super(ResNetV1dWithFC, self).__init__(
            deep_stem=True, avg_down=True, **kwargs)

@BACKBONES.register_module()
class ResNeStWithFC(ResNetV1dWithFC):
    """ResNeSt backbone.
    ...
    def __init__(self,
        ...
        super(ResNeStWithFC, self).__init__(depth=depth, **kwargs)
